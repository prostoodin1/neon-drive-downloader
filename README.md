...
- отдельная вкладка «Выгрузка» для отправки локальных файлов на подключённый Google Drive;
...
Для выгрузки откройте вкладку «Выгрузка», выберите локальные файлы или папку,
...
- **Выгрузка** — локальные источники и папка Google Drive, выбранные через
  стандартный Проводник Windows, с такой же очередью и контролами процесса.
